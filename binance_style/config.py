...
RECENT_HIGH_WINDOW_MIN = 60 # 高位回落过滤(娜姐2026-09-03 最终): 进入起点区前回溯最近60分钟费率历史
RECENT_HIGH_ABS = 0.0005    # 高位回落判定阈值: 窗口内出现过 |费率| > 0.05% 即视为高位回落假起点, 不建起点/不入监控 (娜姐2026-09-03: 初定0.10%改定0.05%)
